...
// player[13] = 
	...
	if (session.new == true){
		...
		return {
			...
			session,
			response: {
				text: 'Здравствуй! Я романтический оракул. Я могу рассказать тебе твоё будущее. А могу передать кому-нибудь твоё романтическое послание. Чтобы узнать подробнее - скажи ПОМОЩЬ. Ну что, начнём?',
				card: {
					type: "BigImage",
